...
export const base64 = 'etnrisouaflchpdvmgybwESxTNCkLAOM_DPHBjFIqRUzWXV$JKQGYZ0516372984';
...
export const KEY_WORDS_BEFORE_EXPRESSION = array_to_hash([
  'return',
  'new',
  'delete',
  'throw',
...
export const OPERATORS = array_to_hash([
  'in',
  'instanceof',
  'typeof',
  'new',
...
export const WHITESPACE_CHARS = array_to_hash(characters(' \u00a0\n\r\t\f\u000b\u200b\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\uFEFF'));
...
export const UNARY_POSTFIX = array_to_hash([
  '++',
  '--',
]);
